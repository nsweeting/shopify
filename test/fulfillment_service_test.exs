defmodule Shopify.FulfillmentServiceTest do
  ...
  test "client can request a single fulfillment_service" do
    ...
    fixture = Fixture.load("../test/fixtures/fulfillment_services/1.json", "fulfillment_service", FulfillmentService.empty_resource())
  ...
  test "client can request all fulfillment_services" do
    ...
    assert %Shopify.Response{} = response
    assert 200 == response.code
    fixture = Fixture.load("../test/fixtures/fulfillment_services.json", "fulfillment_services", [FulfillmentService.empty_resource()])
    assert fixture == response.data
  end
