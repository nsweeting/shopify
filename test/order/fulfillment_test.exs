defmodule Shopify.FulfillmentTest do
  ...
  test "client can request a single fulfillment" do
    ...
    fixture =
      Fixture.load(
        "../test/fixtures/orders/1/fulfillments/1.json",
        "fulfillment",
        Fulfillment.empty_resource()
      )
  ...
  test "client can request all fulfillments" do
    ...
    fixture =
      Fixture.load("../test/fixtures/orders/1/fulfillments.json", "fulfillments", [
        Fulfillment.empty_resource()
      ])
  ...
  test "client can request to complete a fulfillment" do
    ...
    fixture =
      Fixture.load(
        "../test/fixtures/orders/1/fulfillments/1/complete.json",
        "fulfillment",
        Fulfillment.empty_resource()
      )
  ...
  test "client can request to open a fulfillment" do
    ...
    fixture =
      Fixture.load(
        "../test/fixtures/orders/1/fulfillments/1/open.json",
        "fulfillment",
        Fulfillment.empty_resource()
      )
  ...
  test "client can request to cancel a fulfillment" do
    ...
    fixture =
      Fixture.load(
        "../test/fixtures/orders/1/fulfillments/1/cancel.json",
        "fulfillment",
        Fulfillment.empty_resource()
      )
